 ...
 *     "access" = "Drupal\tmgmt\EntityController\JobAccessController",
 *     "form" = {
 *       "edit" = "Drupal\tmgmt\EntityController\JobFormController"
 *     }
 *   },
...
class Job extends Entity {
   ...
   *
   * @param \Drupal\tmgmt\Plugin\Core\Entity\JobItem $job
   *   The job item to add.
   */
  ...
  public function getData(array $key = array(), $index = NULL) {
    ...
    if (!empty($key)) {
      ...
      $job_item = entity_load('tmgmt_job_item', $tjiid);
      if ($job_item) {
